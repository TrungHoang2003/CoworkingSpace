...
public sealed record SpaceErrors
{
   ...
   public static readonly Error NotDailySpaceType  = new Error("Space SpaceAssetType Error", "This space type is a Monthly space type");
   public static readonly Error NotMonthlySpaceType = new Error("Space SpaceAssetType Error", "This space type is a Daily space type");
}